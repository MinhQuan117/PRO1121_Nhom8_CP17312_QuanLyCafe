...
public class AdapterDisplayTable extends BaseAdapter implements View.OnClickListener{
    ...
    Context context;
    int layout;
    List<Ban> banAnDTOList;
    ViewHolder viewHolder;
    BanAnDAO banAnDAO;
    DonDatDAO donDatDAO;
    FragmentManager fragmentManager;

    public AdapterDisplayTable(Context context, int layout, List<Ban> banAnDTOList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Ban banAnDTO = banAnDTOList.get(position);
...
//                FragmentThucDon displayCategoryFragment = new FragmentThucDon();
//
